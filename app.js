...
let D={studio:[],reports:[],training:[],activity:[]};
let libraryCache=[];
...
function load(){
  try{
    ...
    if(x)D={studio:Array.isArray(x.studio)?x.studio:[],reports:Array.isArray(x.reports)?x.reports:[],training:Array.isArray(x.training)?x.training:[],activity:Array.isArray(x.activity)?x.activity:[]};
  }catch(e){}
}
